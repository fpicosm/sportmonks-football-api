...
class TeamSquad extends FootballApiClient
{
     ...
     * @link    https://docs.sportmonks.com/football2/MTf0RssMhRVvcd3EfGAh/getting-started/endpoints/team-squads/get-team-squads-by-team-and-season-id
     * @param   int     $teamId a valid team id from the teams endpoint
     * @param   array   $params the query params
     * @return  object  the response object
     * @throws  GuzzleException
    ...
    {
        return (new Team($teamId))->squadBySeason($seasonId, $params);
    }
}
